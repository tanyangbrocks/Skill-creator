...
public static class TotemLibrary
{
    ...
    public static readonly List<EngraveData> AllEngravings = new()
    {
        ...
        new EngraveData { Id = "act_projectile_energy",   DisplayName = "能量投射發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_projectile_physical", DisplayName = "實物投射發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_passive_continuous",  DisplayName = "持續偵測發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnTick,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_passive_switch",      DisplayName = "開關切換發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnTick,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_morph_speed",         DisplayName = "加速形態發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_morph_flight",        DisplayName = "飛行形態發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_morph_invisible",     DisplayName = "隱身形態發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_morph_strengthen",    DisplayName = "強化形態發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_morph_possession",    DisplayName = "附體形態發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        ...
        new EngraveData { Id = "act_summon_minion",       DisplayName = "召喚精靈發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_summon_turret",       DisplayName = "召喚砲台發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_summon_guardian",     DisplayName = "召喚護衛發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_summon_weapon",       DisplayName = "召喚武器發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_summon_building",     DisplayName = "召喚建築發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_summon_vehicle",      DisplayName = "召喚載具發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_domain_barrier",      DisplayName = "結界領域發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_domain_terrain",      DisplayName = "地形改造發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
        new EngraveData { Id = "act_domain_weather",      DisplayName = "天候操控發動",    Color = EngraveColor.Action, Category = EngraveCategory.Action, Trigger = EngraveTrigger.OnCast,  ScalingType = ScalingType.Linear, ScalingCoefficient = 0f, BaseCost = 0 },
    ...
    // ════════════════════════════════════════════════════════════
    //  Action 刻印 Id → 此 Action 需要容器效果編輯（雙擊動作刻印積木可進入）
    // ════════════════════════════════════════════════════════════

    public static readonly HashSet<string> ContainerActionIds = new()
    {
        "act_projectile_energy",
        "act_projectile_physical",
        "act_summon_minion",
        "act_summon_turret",
        "act_summon_guardian",
        "act_summon_weapon",
    ...
    public static readonly Dictionary<string, string> DefaultActionEngraveId = new()
    {
        ...
        ["projectile_energy"]   = "act_projectile_energy",
        ["projectile_physical"] = "act_projectile_physical",
        ["passive_continuous"]  = "act_passive_continuous",
        ["passive_switch"]      = "act_passive_switch",
        ["morph_speed"]         = "act_morph_speed",
        ["morph_flight"]        = "act_morph_flight",
        ["morph_invisible"]     = "act_morph_invisible",
        ["morph_strengthen"]    = "act_morph_strengthen",
        ["morph_possession"]    = "act_morph_possession",
        ["displace_dash"]       = "act_dash",
        ["displace_teleport"]   = "act_teleport",
        ["displace_dodge"]      = "act_dodge",
        ["displace_portal"]     = "act_portal",
        ["summon_minion"]       = "act_summon_minion",
        ["summon_turret"]       = "act_summon_turret",
        ["summon_guardian"]     = "act_summon_guardian",
        ["summon_weapon"]       = "act_summon_weapon",
        ["summon_building"]     = "act_summon_building",
        ["summon_vehicle"]      = "act_summon_vehicle",
        ["domain_barrier"]      = "act_domain_barrier",
        ["domain_terrain"]      = "act_domain_terrain",
        ["domain_weather"]      = "act_domain_weather",
    };
}
