...
public static class TotemLibrary
{
    ...
    public static readonly List<EngraveData> AllEngravings = new()
    {
        ...
        // ── 屬性（元素）：11 種 ───────────────────────────────────
        new EngraveData { Id = "elem_metal",   DisplayName = "金屬性",  Color = EngraveColor.Elemental, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.8f, BaseCost = 4 },
        new EngraveData { Id = "elem_wood",    DisplayName = "木屬性",  Color = EngraveColor.Elemental, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.8f, BaseCost = 4 },
        new EngraveData { Id = "elem_water",   DisplayName = "水屬性",  Color = EngraveColor.Elemental, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.8f, BaseCost = 4 },
        new EngraveData { Id = "elem_fire",    DisplayName = "火屬性",  Color = EngraveColor.Elemental, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.8f, BaseCost = 4 },
        new EngraveData { Id = "elem_earth",   DisplayName = "土屬性",  Color = EngraveColor.Elemental, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.8f, BaseCost = 4 },
        new EngraveData { Id = "elem_ice",     DisplayName = "冰屬性",  Color = EngraveColor.Elemental, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 1.0f, BaseCost = 5 },
        new EngraveData { Id = "elem_wind",    DisplayName = "風屬性",  Color = EngraveColor.Elemental, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 1.0f, BaseCost = 5 },
        new EngraveData { Id = "elem_light",   DisplayName = "光屬性",  Color = EngraveColor.Elemental, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 1.2f, BaseCost = 6 },
        new EngraveData { Id = "elem_dark",    DisplayName = "暗屬性",  Color = EngraveColor.Elemental, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 1.2f, BaseCost = 6 },
        new EngraveData { Id = "elem_thunder", DisplayName = "雷屬性",  Color = EngraveColor.Elemental, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 1.2f, BaseCost = 6 },
        new EngraveData { Id = "elem_poison",  DisplayName = "毒屬性",  Color = EngraveColor.Elemental, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 1.0f, BaseCost = 5 },

        // ── 法則：14 種 ──────────────────────────────────────────
        new EngraveData { Id = "law_time",      DisplayName = "時間", Color = EngraveColor.Law, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.5f, BaseCost = 15 },
        new EngraveData { Id = "law_space",     DisplayName = "空間", Color = EngraveColor.Law, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.5f, BaseCost = 15 },
        new EngraveData { Id = "law_genesis",   DisplayName = "造化", Color = EngraveColor.Law, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.5f, BaseCost = 15 },
        new EngraveData { Id = "law_causality", DisplayName = "因果", Color = EngraveColor.Law, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.5f, BaseCost = 15 },
        new EngraveData { Id = "law_cycle",      DisplayName = "輪迴", Color = EngraveColor.Law, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.3f, BaseCost = 20 },
        new EngraveData { Id = "law_life_death", DisplayName = "生死", Color = EngraveColor.Law, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.3f, BaseCost = 20 },
        new EngraveData { Id = "law_soul",       DisplayName = "靈魂", Color = EngraveColor.Law, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.3f, BaseCost = 20 },
        new EngraveData { Id = "law_yin_yang",  DisplayName = "陰陽", Color = EngraveColor.Law, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.3f, BaseCost = 20 },
        new EngraveData { Id = "law_extreme",   DisplayName = "極點", Color = EngraveColor.Law, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.2f, BaseCost = 25 },
        new EngraveData { Id = "law_infinite",  DisplayName = "無量", Color = EngraveColor.Law, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.2f, BaseCost = 25 },
        new EngraveData { Id = "law_create",    DisplayName = "創造", Color = EngraveColor.Law, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.2f, BaseCost = 25 },
        new EngraveData { Id = "law_dimension", DisplayName = "次元", Color = EngraveColor.Law, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.2f, BaseCost = 25 },
        new EngraveData { Id = "law_world",     DisplayName = "世界", Color = EngraveColor.Law, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.1f, BaseCost = 30 },
        new EngraveData { Id = "law_chaos",     DisplayName = "混沌", Color = EngraveColor.Law, ScalingType = ScalingType.Hyperbolic, ScalingCoefficient = 0.1f, BaseCost = 30 },
    };
}
